...
public class MemberDaoImpl extends SqlSessionDaoSupport implements MemberDao{
	...
	public int createNewMember(RegistMemberVO registMemberVO) {
		...
		return this.getSqlSession().insert("com.ktdsuniversity.edu.hello_spring.member.dao.MemberDao.createNewMember" , registMemberVO);
	}
	...
	public String selectSalt(String id) {
		...
		return this.getSqlSession().selectOne( NAMESPACE + ".selectSalt" , id);
	}
